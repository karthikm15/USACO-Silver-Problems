...
int main() {
    ...
    for (int i = 0; i < row; i++) {
        for (int j = 0; j < col; j++) {
            ...
            if (i == 0) {
                if (j == 0) {
                    if ((number == arr[i+1][j]) || (number == arr[i+1][j+1]) || (number == arr[i][j-1])) {
                        placeholder = number;
                    }
                }
                else if (j == (col-1)) {
                    ...
                    if ((number == arr[i+1][j]) || (number == arr[i+1][j+1]) || (number == arr[i][j-1]) || 
                        (number == arr[i-1][j+1]) || (number ==  arr[i-1][j+1])) {
                        placeholder = number;
                    }
                }
            }
                ...
                if (j == 0) {
                    ...
                    if ((number == arr[i+1][j]) || (number == arr[i-1][j]) || (number == arr[i+1][j-1]) || 
                        (number == arr[i][j-1]) || (number ==  arr[i-1][j-1])) {
                        placeholder = number;
                    }
                }
            }
            else if (j == (col-1)) {
                if ((number == arr[i][j-1]) || (number == arr[i][j+1]) || (number == arr[i-1][j-1]) || 
                    (number == arr[i-1][j+1]) || (number == arr[i-1][j])) {
                    placeholder = number;
                }
            }
            else if (j == 0) {
                ...
                if ((number == arr[i-1][j-1]) || (number == arr[i-1][j]) || (number == arr[i-1][j+1]) ||
                    (number == arr[i][j-1]) || (number == arr[i][j+1]) || (number == arr[i+1][j-1]) || 
                    (number == arr[i+1][j]) || (number ==  arr[i+1][j-1])) {
                    placeholder = number;
                }
            }
            if (maximum < placeholder) {
                maximum = placeholder;
            }
        }
    }
